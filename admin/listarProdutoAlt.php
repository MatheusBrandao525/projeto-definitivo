...
<div class="container-fluid " style=" height: 100%; padding-bottom:5px;">
	...
	<div class="row exibebusca" style="margin-top: 15px; padding:0 5%;">
		...
		<div class="col-sm-1 col-sm-offset-1 imgBuscar"><img src="../public/assets/imgem/<?php echo $exibeAlt['imagen_produto']; ?>" class="img-responsiva"></div>
        ...
        <a href="../admin/alterarProdutos.php?id=<?php echo $exibeAlt['id_produto'];?>&id2=<?php echo $exibeAlt['id_categoria'];?>" style=" text-decoration:none;">
        <button class="btn btn-sm btn-block btn-info">		
		<span class="glyphicon glyphicon-info-sign" style="color: white;"> Alterar</span>
		</button>
        </a>	
        <a href="../admin/excluiProdutos.php?id=<?php echo $exibeAlt['id_produto'];?>" style=" text-decoration:none;">
